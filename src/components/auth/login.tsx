...
const Login = ({ email, setEmail, password, setPassword, loading, error, onLogin }: LoginProps) => {
  return (
          ...
          <form onSubmit={onLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="h-12 border-slate-200 focus-visible:ring-blue-500 focus-visible:border-blue-500"
                required
              />
            </div>
